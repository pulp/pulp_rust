...
class RustContentSerializer(platform.SingleArtifactContentSerializer):
    """
    A Serializer for RustContent.

    Add serializers for the new fields defined in RustContent and
...
class RustRemoteSerializer(platform.RemoteSerializer):
    """
...
class RustRepositorySerializer(platform.RepositorySerializer):
    """
...
class RustPublicationSerializer(platform.PublicationSerializer):
    """
    A Serializer for RustPublication.

    Add any new fields if defined on RustPublication.
    Similar to the example above, in RustContentSerializer.
    Additional validators can be added to the parent validators list
    ...
    class Meta:
        ...
        model = models.RustPublication


class RustDistributionSerializer(platform.DistributionSerializer):
    """
