...
def synchronize(remote_pk, repository_pk, mirror):
    ...
    first_stage = RustFirstStage(remote, deferred_download)
    DeclarativeVersion(first_stage, repository, mirror=mirror).create()


class RustFirstStage(Stage):
    """
    The first stage of a pulp_rust sync pipeline.
    """
    ...
    def read_my_metadata_file_somehow(self, path):
        """
        Parse the metadata for rust Content type.
